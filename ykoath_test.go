...
func TestPutAndCalculateTestVector(t *testing.T) {
	...
	t.Run("multiple match error", func(t *testing.T) {
		...
		err := client.Put("testvector1", HmacSha1, Totp, 8, []byte("12345678901234567890"), false, false, 0)
		err = client.Put("testvector2", HmacSha1, Totp, 8, []byte("12345678901234567890"), false, false, 0)
